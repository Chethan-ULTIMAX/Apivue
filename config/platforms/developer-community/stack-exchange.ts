...
export const stackExchange: PlatformDefinition = {
  "id": "stack-exchange",
  "name": "Stack Exchange",
  "description": "Stack Exchange platform integration contract.",
  "category": "developer-community",
  "websiteUrl": "https://stackexchange.com",
  ...
  "endpoints": [{ "operationId": "public-lookup", "name": "Public user lookup", "description": "Fetch a public Stack Exchange user profile.", "method": "GET", "path": "/users/{userId}?site=stackoverflow", "authentication": "public", "responseType": "StackExchangeUser", "documentationUrl": "https://api.stackexchange.com/docs/users-by-ids" }],

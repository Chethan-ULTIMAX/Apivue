...
export const portswigger: PlatformDefinition = {
  "id": "portswigger",
  "name": "PortSwigger Web Security Academy",
  "description": "PortSwigger Web Security Academy platform integration contract.",
  "category": "security",
  "websiteUrl": "https://portswigger.net/web-security",
  "documentationUrl": "",
  "authentication": [
    "public"
  ],

...
export const openapiInitiative: PlatformDefinition = {
  "id": "openapi-initiative",
  "name": "OpenAPI Initiative",
  "description": "OpenAPI Initiative platform integration contract.",
  "category": "api-ecosystem",
  "websiteUrl": "https://openapis.org",
  "documentationUrl": "",
  "authentication": [
    "public"
  ],
